...
from session.session_uuid import SessionUUID
...
class Database:
    ...
    def database_attributes_create(logger: object) -> dict:
        ...
        # Retains pascal case formatting on keys, this is imperative for interacting with the iRacing SDK.
    ...
    def database_connect(
        ...
        if database_manager.lower() == "sqlite3":
            ...
            return logger.error("MySQL not fully implemented yet.")
    ...
    def table_insert(
        ...
        new_entry_uuid = SessionUUID.generate_uuid()
